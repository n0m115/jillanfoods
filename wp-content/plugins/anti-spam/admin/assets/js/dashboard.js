jQuery(document).ready(function ($) {
        ...
        $.ajax(ajaxurl, {
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if (data.error_message) {
                    ...
                    noticeId = $.wbcr_factory_clearfy_236.app.showNotice(data.message, 'success');
                }
    ...
    jQuery('[data-action="digest-state"]').on('click', function (e) {
        ...
        jQuery.post(ajaxurl, {
            ...
            var noticeId = jQuery.wbcr_factory_clearfy_236.app.showNotice(msg, type);
            setTimeout(function () {
                jQuery.wbcr_factory_clearfy_236.app.hideNotice(noticeId);
            }, 5000);
        });
    })
