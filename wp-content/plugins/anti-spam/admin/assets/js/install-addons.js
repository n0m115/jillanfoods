    ...
    var wtitan_externalAddon = {
        ...
        events: function () {
            ...
            $(document).on('click', '.wtitan-update-component-button', function () {
                ...
                $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/pre_update', [$this, data]);
                ...
                self.sendRequest(data, function (response) {
                    if (!response || !response.success) {
                        ...
                        $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/update_error', [
                            $this,
                            data,
                    ...
                    if (response.success) {
                        ...
                        if (plugin_action == 'install') {
                            ...
                            $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/installed', [
                                $this,
                                data,
                                response
                            ]);
                            ...
                            $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/pre_activate', [
                                $this,
                                data,
                                response
                            ]);
                            ...
                            $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/deactivated', [
                                $this,
                                data,
                                response
                            ]);
                            ...
                            $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/deleted', [$this, data, response]);
                        }
                    } else {
                        if (plugin_action == 'install') {
                    ...
                    $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/updated', [$this, data, response]);
                });
        ...
        sendRequestToComponentActivationPrepare: function (componentButton, sendData, button_i18n) {
            ...
            this.sendRequest(sendData, function (response) {
                ...
                if (!response || !response.success) {
                    ...
                    $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/activated_error', [sendData.plugin]);
                    return;
                }
                ...
                $.wbcr_factory_clearfy_236.hooks.run('clearfy/components/activated', [sendData.plugin]);
            });
        },
