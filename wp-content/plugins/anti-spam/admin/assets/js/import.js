        ...
        importOptions: function () {
            ...
            $('.wtitan-import-options-button').click(function () {
                ...
                if (void 0 == wtitan_ajax || !wtitan_ajax.import_options_nonce) {
                    $.wbcr_factory_clearfy_236.app.showNotice('Unknown Javascript error, most likely the wtitan_ajax variable does not exist!', 'danger');
                    return false;
                }
            ...
            $.ajax(ajaxurl, {
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (!data || data.error) {
                        ...
                        if (data) {
                            ...
                            if (void 0 !== wtitan_ajax) {
                                noticeId = $.wbcr_factory_clearfy_236.app.showNotice(wtitan_ajax.i18n.unknown_error, 'danger');
                            }
                        }
                    ...
                    if (!request_data.flush_redirect) {
                        if (void 0 !== wtitan_ajax) {
                            noticeId = $.wbcr_factory_clearfy_236.app.showNotice(wtitan_ajax.i18n.success_update_settings, 'success');
