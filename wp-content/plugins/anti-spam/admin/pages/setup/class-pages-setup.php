...
class Setup extends \WBCR\FactoryClearfy236\Pages\Setup {
	...
	public function __construct(\Wbcr_Factory445_Plugin $plugin)
	{
		...
		#Step 1 is default \WBCR\FactoryClearfy236\Pages\Step_Plugins
		$this->register_step($path . '/class-step-default.php', '\WBCR\Titan\Page\Step_Default');

		#Step 2 \WBCR\FactoryClearfy236\Pages\Step_Plugins
