...
if ( ! class_exists( 'Wbcr_FactoryPages444_ImpressiveThemplate' ) ) {
	...
	abstract class Wbcr_FactoryPages444_ImpressiveThemplate extends Wbcr_FactoryPages444_AdminPage {
		...
		public function getPluginTitle() {
			 ...
			 */
			$plugin_title = wbcr_factory_445_apply_filters_deprecated( 'wbcr/factory/imppage/plugin_title', [
		...
		public function flushCacheAndRulesAction() {
			...
			if ( class_exists( 'WbcrFactoryClearfy236_Helpers' ) ) {
			 ...
			 */
			wbcr_factory_445_do_action_deprecated( 'wbcr_factory_445_imppage_flush_cache', [
				$this->plugin->getPluginName(),
				$this->getResultId()
			], '4.0.1', 'wbcr_factory_445_imppage_after_form_save' );

			/**
			 * @since 4.0.9 - является устаревшим
			 */
			wbcr_factory_445_do_action_deprecated( 'wbcr_factory_445_imppage_after_form_save', [
				$this->plugin,
				$this
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			$redirect_args = wbcr_factory_445_apply_filters_deprecated( 'wbcr_factory_445_imppage_after_form_save_redirect_args', [ $redirect_args ], '4.0.9', 'wbcr/factory/pages/impressive/save_redirect_args' );
		...
		protected function printAllNotices() {
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			wbcr_factory_445_do_action_deprecated( 'wbcr_factory_pages_444_imppage_print_all_notices', [
				$this->plugin,
				$this
		...
		private function showActionsNotice() {
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			$notices = wbcr_factory_445_apply_filters_deprecated( 'wbcr_factory_pages_444_imppage_actions_notice', [
				$notices,
				$this->plugin,
				$this->id
		...
		protected function showOptions() {
			...
			if ( isset( $_POST[ $this->plugin->getPluginName() . '_save_action' ] ) ) {
				 ...
				 * @since 4.0.9 - является устаревшим
				 */
				wbcr_factory_445_do_action_deprecated( 'wbcr_factory_445_imppage_before_form_save', [
					$form,
					$this->plugin,
					$this
				 ...
				 * @since 4.0.9 - является устаревшим
				 */
				wbcr_factory_445_do_action_deprecated( 'wbcr_factory_445_imppage_form_saved', [
					$form,
					$this->plugin,
					$this
