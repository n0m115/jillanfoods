...
class Wbcr_FactoryClearfy236_PageBase extends Wbcr_FactoryPages444_ImpressiveThemplate {
	...
	public function assets( $scripts, $styles ) {
		...
		wbcr_factory_445_do_action_deprecated( 'wbcr_clearfy_page_enqueue_scripts', [
			$this->getResultId(),
			$scripts,
			$styles
        ...
        <div class="wbcr-factory-sidebar-widget">
			...
			<?php if ( get_locale() !== 'ru_RU' ): ?>
                <form id="wbcr-factory-paypal-donation-form" action="https://www.paypal.com/cgi-bin/webscr"
                    ...
                    <input type="image" src="<?= FACTORY_PAGES_444_URL ?>/templates/assets/img/paypal-donate.png"
