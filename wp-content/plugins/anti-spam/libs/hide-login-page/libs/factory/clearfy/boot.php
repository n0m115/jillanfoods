...
define( 'FACTORY_CLEARFY_236', '2.1.9' );
...
if ( is_admin() ) {
	...
	add_action( 'admin_enqueue_scripts', function () {
		wp_enqueue_script( 'wbcr-factory-clearfy-236-global', FACTORY_CLEARFY_236_URL . '/assets/js/globals.js', [ 'jquery' ], FACTORY_CLEARFY_236 );
	} );
