( function( $ ){
    ...
    $.fn.factoryBootstrap445_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap445_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-445 .factory-integer").factoryBootstrap445_integerControl();
    });
