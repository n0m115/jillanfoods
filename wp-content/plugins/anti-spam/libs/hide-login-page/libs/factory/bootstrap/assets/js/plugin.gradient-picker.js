	...
	GradientSelection.prototype = {    
		...
		this.g2d = canvas.getContext("2d");
            ...
            _createColorPicker: function() {
                ...
                this.$colorPicker.factoryBootstrap445_iris({
                    width: 217,
                ...
                self.$colorHex.on('change paste keyup', function(){
                    ...
                    self.$colorPicker.factoryBootstrap445_iris('color', self.$colorHex.val());
		...
		this.$el.append( this.$directionDropdown );  
            ...
            showColorPicker: function( point ) {
                ...
                this.$colorPicker.factoryBootstrap445_iris( 'show' );
                this.$colorPicker.factoryBootstrap445_iris( 'option', 'color', point.color );
