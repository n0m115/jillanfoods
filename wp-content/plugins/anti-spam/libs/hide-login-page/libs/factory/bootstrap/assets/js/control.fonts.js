...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap445.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap445_fontControl", $.factoryBootstrap445.fontControl );
        $(".factory-bootstrap-445 .factory-font").factoryBootstrap445_fontControl({});
    });
