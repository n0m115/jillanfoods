( function( $ ){
    ...
    $.fn.factoryBootstrap445_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap445_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-445 .factory-paddings-editor").factoryBootstrap445_paddingsEditor();
    });
