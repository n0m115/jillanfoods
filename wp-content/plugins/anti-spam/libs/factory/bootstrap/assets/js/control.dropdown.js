( function($) {
	...
	$.fn.factoryBootstrap445_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap445_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-445 .factory-dropdown").factoryBootstrap445_dropdownControl();
	});
