...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap445.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap445_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap445_patternControl", $.factoryBootstrap445.patternControl );
        $(".factory-bootstrap-445 .factory-pattern").factoryBootstrap445_patternControl({});
    });
